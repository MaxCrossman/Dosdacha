        ...
        <div class="container-fluid">
            ...
            <ul class="nav d-inline-flex mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link text-white" href="/newboard">New Board</a>
                </li>
            </ul>
                        ...
                        <form action="/newboard" method="post">
                            <div class="form-group">
                                <div class="row justify-content-center pb-2">
                                    <div class="col-md-auto">
                                        <input type="text" class="form-control" name="name" placeholder="Board Name">
                                    </div>
                                </div>
                                <div class="row justify-content-center pb-2">
                                    <div class="col-md-auto">
                                        <input type="text" class="form-control" name="address" placeholder="Board Address">
                                    </div>
                                </div>
                                <div class="row justify-content-center pb-2">
                                    <div class="col-md-auto">
                                        <input type="submit" class="btn btn-outline-success" value="Create Board">
                                    </div>
                                </div>
                            </div>
                        </form>
